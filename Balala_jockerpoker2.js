//mid ahh balala/jokerpoker remake listed below :) 
//pls dont sue me locl thunk :(
...
let shopItems = [
  {
    name: "Buy 3 Rerolls [R]",
    cost: 500,
    action: () => { rerollsLeft += 3; },
  },
  {
    name: "Increase Max Hands [H]",
    cost: 800,
    action: () => { maxHands++; },
  },
  {
    name: "Buy Mystery Joker [M]",
    cost: 1000,
    action: () => { 
...
function drawShop() {
  ...
  fill(255);
  textSize(24);
  text('Continue [ENT]', width / 2, continueY + 25);
}
